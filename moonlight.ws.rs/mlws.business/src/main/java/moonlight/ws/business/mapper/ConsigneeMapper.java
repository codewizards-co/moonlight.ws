...
@RequestScoped
public class ConsigneeMapper extends AbstractMapper<ConsigneeEntity, ConsigneeDto> {
	...
	@Override
	protected void copyPropertiesToEntity(@NonNull ConsigneeEntity entity, @NonNull ConsigneeDto dto) {
	...
	@Override
	protected void copyPropertiesToDto(@NonNull ConsigneeDto dto, @NonNull ConsigneeEntity entity) {
